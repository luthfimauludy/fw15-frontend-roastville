        ...
        <div className="bg-no-repeat bg-cover bg-slate-100 lg:mx-20 rounded-lg p-10 flex flex-col md:flex-row justify-center gap-10">
          <div className="flex flex-col gap-10 items-center md:w-80">
            ...
            <div className="flex flex-col gap-5">
              <button
                className="w-48 md:w-32 lg:w-48 hover:bg-gray-400 active:bg-slate-600 active:scale-[.9] duration-300 bg-primary h-16 rounded-3xl"
              >
                Save
              </button>
              <button
                className="w-48 md:w-32 lg:w-48 hover:bg-gray-400 active:bg-slate-600 active:scale-[.9] duration-300 bg-secondary h-16 rounded-3xl"
              >
                Cancel
              </button>
            </div>
